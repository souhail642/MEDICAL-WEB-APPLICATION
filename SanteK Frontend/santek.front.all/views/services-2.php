...
<head>
    ...
    <script src="https://www.paypalobjects.com/api/checkout.js"></script>    <link href="../../pages/calendar.php">
...
<center>
                            <div class="ms-panel-body">
                                <form class="needs-validation" name="e" method="POST" action="../Prr/views/PageDePaiement.html" >
                                    <div class="form-row">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<form id="contact-form" name="contact-form" method="POST" action="send.php">
							...
							<button class="btn btn-default btn-outline waves waves-dark" id="submit" type="submit" name="submit" value="">submit </button>
					...
					<div class="widget widget-contact ml-lg-5">
						...
						<ul>
							...
							<li>
								...
								<a href="mailto:mariem.nacib@esprit.tn">contact@santek.tn</a>
							</li>
						</ul>
