...
class PayPalPayment {
	 ...
	 */
	public function setClientID($id_par) {
		$this->id_par = $id_par;
	}
	...
	public function setSecret($secret) {
		$this->participant_secret = $secret;
	}
	...
	public function generateAccessToken() {
		...
		curl_setopt($ch, CURLOPT_POSTFIELDS, "grant_type=participant_credentials");
		curl_setopt($ch, CURLOPT_POST, 1);
		curl_setopt($ch, CURLOPT_USERPWD, $this->id_par . ":" . $this->participant_secret);
