                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            ...
                            <p>
                                <input class="col-12" id="first_name" type="text" name="first_name" value="" placeholder="" required>
                                <span></span>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <p>
                                <input class="col-12" id="last_name" type="text" name="last_name" value="" placeholder="" required>
                                <span></span>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <p>
                                <input class="col-12" id="email" type="text" name="email" value="" placeholder="" required>
                                <span></span>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <p>
                                <input class="col-12" id="phone" type="number" name="phone" value="" placeholder="" required>
                                <span></span>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <p>
                                <select class="col-12" id="speciality" name="speciality" value="" type="text">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <p>
                                <input class="col-12" id="date1" type="date" name="date1" value="" required>
                                <span></span>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <p>
                                <input class="col-12" id="hours" type="time" name="hours" value="" required>
                                <span></span>
                    ...
                    <p>
                        <textarea class="col-12" id="description" name="description" rows="5" cols="25" value="" placeholder="" required></textarea>
                        <span></span>
