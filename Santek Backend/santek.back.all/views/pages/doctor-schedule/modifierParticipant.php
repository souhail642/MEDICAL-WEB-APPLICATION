...
<!---------------------------------------------------------------MODIFIER------------------------------------------------------------------------>
<form name="e" method="POST" action="participant.php">          
          <?PHP
...
if (isset($_GET['id_par'])){
  ...
  $result=$participantC->recupererParticipant($_GET['id_par']);
	foreach($result as $row){
    $id_par=$row['id_par'];
		$nom_par=$row['nom_par'];
		$prenom_par=$row['prenom_par'];
    $login_par=$row['login_par'];
    $pwd_par=$row['pwd_par'];
    $grp_sang=$row['grp_sang'];
?>
...
<br>
    ...
    <div class="controls">
   <input type="hidden" name="id_par" id="reff" value="<?PHP echo $id_par ?>">
    </div>
    <p>
</div>
...
<div class="ms-panel-body">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="nom_par" name="nom_par" placeholder="Entrez votre prénom" value="<?PHP echo $nom_par ?>"required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="prenom_par">Prénom</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="prenom_par" name="prenom_par" placeholder="Entrez votre Nom" value="<?PHP echo $prenom_par ?>" required>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="email" class="form-control" id="login_par" name="login_par" placeholder="Entrez votre e-mail" value="<?PHP echo $login_par ?>" required>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" id="pwd_par" name="pwd_par" placeholder="Entrer le mot de passe" value="<?PHP echo $pwd_par ?>" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="grp_sang" name="grp_sang" value="<?PHP echo $grp_sang ?>" required>
...
if (isset($_POST['Modifier'])){
	$participant=new participant($_POST['nom_par'],$_POST['prenom_par'],$_POST['login_par'],$_POST['pwd_par'],$_POST['grp_sang'],$_POST['id_par']);
	$participantC->modifierParticipant($participant,$_POST['id_par']);
